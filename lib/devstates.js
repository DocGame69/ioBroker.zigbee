...
const states = {
 ...
 //    },
    ...
    brightness: {
     ...
     //temp       return {transition: transitionTime};
           return {transition: 0};
        ...
        readTimeout: (value, options) => {
            const hasTransitionTime = options && options.hasOwnProperty('transition_time');
            const transitionTime = hasTransitionTime ? options.transition_time : 0;
     //temp       return transitionTime * 1000;
           return 0;
        },
    },
    colortemp: {
...
const devices = [{
    ...
    },
   {
    ...
    },
    {
        ...
        states: [states.rwl_state, states.rwl_up_button, states.rwl_down_button, states.battery],
    },
    {
        vendor: 'Philips',
        models: ['SML001'],
    ...
    },
    {
        vendor: 'Innr',
        models: [
            'RB 165', 'RB 175 W', 'RS 125', 'RS 128 T', 'RB 145', 'PL 110', 'ST 110', 'UC 110',
